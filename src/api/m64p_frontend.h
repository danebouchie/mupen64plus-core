 ...
 */
typedef m64p_error(*ptr_CoreStartup)(int, const char *, const char *, void *, const char *, ptr_DebugCallback, void *, ptr_StateCallback);
#if defined(M64P_CORE_PROTOTYPES)
EXPORT m64p_error CALL CoreStartup(int, const char *, const char *, void *, const char *, ptr_DebugCallback, void *, ptr_StateCallback);
#endif
